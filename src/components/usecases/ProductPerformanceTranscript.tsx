...
export default function ProductPerformanceTranscript() {
  return (
          ...
          <div className="flex justify-end">
            <div className="relative max-w-[min(420px,85%)]">
              <div className="px-3 py-2 text-[14px] leading-5 tracking-[-0.15px] whitespace-pre-wrap" style={{ "background": "var(--grok-bot-bubble-user)", "color": "var(--grok-bot-bubble-user-ink)", "borderRadius": "16px" } as React.CSSProperties}>
                {"watch checkout latency and tell me when something moves."}
              </div>
            </div>
          </div>
        </div>
        <div className="baby-grok-bot-entry-enter mt-3 first:mt-0">
          ...
          <div className="max-w-[min(420px,92%)]">
            <div className="baby-grok-bot-card">
              ...
              <p className="mt-0.5">
                {"Approve the SSO prompt on Datadog so I can pull the checkout traces."}
              </p>
              <div className="mt-2.5">
                <div className="overflow-hidden" style={{ "borderRadius": "10px", "opacity": "1" } as React.CSSProperties}>
                  <div className="group/desktop relative max-h-full w-full overflow-hidden rounded-md aspect-[16/10] !rounded-none" style={{ "--rd-base-width": "360px", "--rd-base-height": "224.99011351153422px", "--rd-content-scale": "0.5926649305555556" } as React.CSSProperties}>
                    <img alt="" className="absolute inset-0 h-full w-full object-cover remote-desktop-wallpaper remote-desktop-wallpaper--light" draggable="false" src="/media/cloud-agents-1.webp" />
                    <img alt="" className="remote-desktop-wallpaper remote-desktop-wallpaper--dark absolute inset-0 h-full w-full object-cover" draggable="false" src="/media/cloud-agents-4.webp" />
          ...
          <div className="flex max-w-[min(560px,92%)] flex-col items-start">
            <div className="relative">
              <div className="baby-grok-bot-md px-3 py-2 text-[14px] leading-5 tracking-[-0.15px] whitespace-pre-wrap" style={{ "background": "var(--grok-bot-bubble-agent)", "color": "var(--cursor-text-primary)", "borderRadius": "16px" } as React.CSSProperties}>
                <span>
                  {"checkout p95 spiked overnight. logged into datadog on my computer and pulled flamegraphs: 2 hot spots in the payment path. writeup + screenshots in the doc."}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex max-w-[min(560px,92%)] flex-col items-start">
            <div className="relative">
              <div className="baby-grok-bot-md px-3 py-2 text-[14px] leading-5 tracking-[-0.15px] whitespace-pre-wrap" style={{ "background": "var(--grok-bot-bubble-agent)", "color": "var(--cursor-text-primary)", "borderRadius": "16px" } as React.CSSProperties}>
                ...
                <span>
                  {", up from 780ms at the same hour last week. both hot spots sit in the tax lookup: one retry loop with no backoff, one currency call that stopped hitting cache after friday's deploy."}
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="baby-grok-bot-card">
              ...
              <dl className="baby-grok-bot-message-panel mt-2">
                ...
                <div className="baby-grok-bot-message-row">
                  ...
                  <dd>
                    {"Checkout p95 overnight"}
                  </dd>
                </div>
                <div className="baby-grok-bot-message-body">
                  <p>
                    {"Checkout p95 went from 780ms to 2.1s overnight. Flamegraphs point at two hot spots in the payment path: a retry loop without backoff and a currency call that stopped hitting cache after Friday's deploy."}
                  </p>
                  <p>
                    {"Writeup and screenshots are in the doc."}
                  </p>
                </div>
              </dl>
            </div>
        ...
        <div className="baby-grok-bot-entry-enter">
          <div className="flex max-w-[min(560px,92%)] flex-col items-start">
            <div className="relative">
              <div className="baby-grok-bot-md px-3 py-2 text-[14px] leading-5 tracking-[-0.15px] whitespace-pre-wrap" style={{ "background": "var(--grok-bot-bubble-agent)", "color": "var(--cursor-text-primary)", "borderRadius": "16px" } as React.CSSProperties}>
                <span>
                  {"posted in #team-eng-perf with the pack."}
                </span>
              </div>
            </div>
          </div>
